...
export function HeroCard({ content, isToday, loading, onGenerated }: HeroCardProps) {
  ...
  if (loading) {
    return (
      <div className="rounded-xl bg-[#111118] card-shadow p-6 mb-6 animate-pulse">
  ...
  if (!content) {
    return (
      <div className="rounded-xl bg-[#111118] card-shadow p-8 mb-6 text-center">
  ...
  return (
    <div className="rounded-xl bg-gradient-to-br from-[#111118] to-[#161625] card-shadow p-6 mb-6">
